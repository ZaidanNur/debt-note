...
"[project]/debt-note/src/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (email === 'user@example.com' && password === 'password') {
            ...
            const response = __TURBOPACK__imported__module__$5b$project$5d2f$debt$2d$note$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                user: {
                    id: '1',
                    name: 'John Doe',
                    email: email
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ce4454b._.js.map